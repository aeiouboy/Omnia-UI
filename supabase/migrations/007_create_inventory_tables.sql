...
-- สร้างตาราง locations สำหรับเก็บข้อมูลสถานที่
...
-- สร้างตาราง inventory สำหรับเก็บข้อมูลสินค้าคงคลัง
...
-- สร้างตาราง inventory_movements สำหรับเก็บประวัติการเคลื่อนไหวของสินค้า

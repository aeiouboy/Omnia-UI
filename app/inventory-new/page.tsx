...
export default function InventoryPage() {
  ...
  const [itemTypeFilter, setItemTypeFilter] = useState<"weight" | "pack" | "pack_weight" | "normal" | "all">("all")
  const [configFilter, setConfigFilter] = useState<"valid" | "invalid" | "all">("all")
  ...
  const loadData = useCallback(async (showLoadingState = true) => {
    ...
    try {
      ...
      const calculatedSummary = {
        ...
        healthyItems: allItems.filter(item => item.status === "inStock").length,
        lowStockItems: allItems.filter(item => item.status === "low").length,
        criticalStockItems: allItems.filter(item => item.status === "outOfStock").length,
  ...
  const handleTabChange = (value: string) => {
    setActiveTab(value as "all" | "low" | "outOfStock")
  ...
  const handleItemTypeChange = (value: string) => {
    setItemTypeFilter(value as "weight" | "pack" | "pack_weight" | "normal" | "all")
    setPage(1)
  }

  const handleConfigChange = (value: string) => {
    setConfigFilter(value as "valid" | "invalid" | "all")
    setPage(1)
  }
  ...
  const handleViewChange = (value: string) => {
    ...
    router.push(`/inventory-new${queryString ? `?${queryString}` : ''}`)
  }
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              {activeStoreFilter && (
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => router.push("/inventory-new/stores")}
          ...
          <div className="flex items-center gap-2">
            {!activeStoreFilter && (
              <Button variant="outline" onClick={() => router.push("/inventory-new/stores")}>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      <div>
                        <CardTitle>
                          ...
                          {activeTab === "outOfStock" && "Out of Stock"}
                        </CardTitle>
                        <CardDescription>
                    ...
                    <div className="flex flex-wrap items-center justify-end gap-2 pt-2 border-t">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="w-[180px] pl-9 h-9 text-sm"
                        />
                      </div>
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="w-[150px] pl-9 h-9 text-sm"
                        />
                      </div>
                      ...
                      <Select value={itemTypeFilter} onValueChange={handleItemTypeChange}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="pack_weight">Pack Weight</SelectItem>
                      ...
                      <Select value={configFilter} onValueChange={handleConfigChange}>
                        <SelectTrigger className="w-[130px] h-9">
                          <SelectValue placeholder="All Stock Config" />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="all">All Stock Config</SelectItem>
                          <SelectItem value="valid">Config Valid</SelectItem>
                          <SelectItem value="invalid">Config Invalid</SelectItem>
                        </SelectContent>
                      </Select>
